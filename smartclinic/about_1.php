        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.php">Home</a></span> <a href="about_1.php" ><span>About</span></a></p>
          ...
          <div class="col-md-2">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="index_1.php" class="py-2 d-block">Home</a></li>
                <li><a href="login.php" class="py-3 d-block">Blog</a><li>
              </ul>
            </div>
          </div>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="login.php"><span class="icon icon-phone"></span><span class="text">+233 54 745 1485</span></a></li>
	                <li><a href="login.php"><span class="icon icon-envelope"></span><span class="text">group8soft.Eng@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
