...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="index_1.php" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="about_1.php" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="services_1.php" class="nav-link">Services</a></li>
	          <li class="nav-item cta"><a href="login.php" class="nav-link"><strong>Log-in</strog></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    	...
    	<div class="container">
    		<div class="row no-gutters">
    			<div class="col-md-3 color-1 p-4">
    				...
    				<span class="phone-number">+ (233) 020 029 8284</span>
					<span class="phone-number"> </br>+ (233) 020 523 0833</span>
    			</div>
      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(images/person_6a.jpg);"></div>
          ...
          <div class="col-md-2">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="about_1.php" class="py-2 d-block">About</a></li>
                <li><a href="index_1.php" class="py-2 d-block">Features</a></li>
                
                <li><a href="index_1.php" class="py-2 d-block">Blog</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4 pr-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="#">The healthcare of the people!</a></h3>
                  <div class="meta">
          ...
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">University Of Cape Coast</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+233 205 804 515</span></a></li>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with <i class="icon-heart" aria-hidden="true"></i> by group 8
